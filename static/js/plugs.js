...
$.fn
    .extend({
         ...
         * tbodyContent 内容的格式 必要参数 function(data){ return "xxxx"; }
         * data为数据集合 返回数据为<tr><td>xx<td/></tr> footcolspan 合并的列数
         * default 0 currentPage 当前页码 default 1 tableId 表格id default
         * tbRecord pageSize 每页记录 default 10 showProgressBar 进度条 default
         * false complated 加载完成时间 default function(){ }
         * 
         */
                    ...
                    $
                        .ajax({
                            ...
                            success: function(d) {
                                ...
                                var str = "<table class='table table-striped table-bordered table-hover table-checkable table-responsive datatable' id='" +
                                    e.tableId +
                                    "'>" +
                                    "<thead>" +
                                    "<tr>" +
                                ...
                                str += "</tbody>";
                                str += "<tfoot style='background-color:#f9f9f9;'>" +
                                    "<tr>" +
                                    "<td colspan='" +
                                    e.footcolspan +
                                                ...
                                                .animate({
                                                    ...
                                                    function() {
                                                        $(
                                                                ".ulpageRecord")
                                                            .stop();
                                                        $.pageRecordEventArg.currentPage = $(
                                                                ".ulpageRecord li")
                                                            .first()
                                                            .html();
                                                        $.pageObject
                                                            .jq_pageRecord($.pageRecordEventArg);
                                                    });
                                        });
                                $(".pagelast")
                                    .click(
